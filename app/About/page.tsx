    ...
    >
      ...
      >
        ...
        <p className="text-gray-700 text-lg leading-relaxed mb-6">
          ...
          designed to help users organize their daily tasks and improve
          productivity. The app focuses on clarity, speed, and ease of use.
        </p>
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            solution that helps users stay organized without unnecessary
            complexity.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed">
            We aim to continuously enhance Task Manager with useful features
            while keeping the experience simple and user-friendly for everyone.
          </p>
        </section>
      </div>
    </main>
